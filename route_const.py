search_shinkansen = [
    ...
    set(['大宮', 'さいたま新都心', '鶯谷', '上野']), # 上野～大宮
    set(['上野', '御徒町', '神田', '東京']), # 東京～上野
    set(['東京', '有楽町', '高輪ゲートウェイ', '品川']), # 品川～東京
    set(['品川', '大井町', '鴨宮', '小田原']), # 小田原～品川
...
nodes = (
    ...
    {'name1': '田町', 'name2': '高輪ゲートウェイ', 'dist': 13},
    {'name1': '高輪ゲートウェイ', 'name2': '品川', 'dist': 9},
    ...
    {'name1': '木更津', 'name2': '祇園', 'dist': 26},
    {'name1': '祇園', 'name2': '上総清川', 'dist': 16},
    {'name1': '上総清川', 'name2': '東清川', 'dist': 19},
    {'name1': '東清川', 'name2': '横田', 'dist': 32},
    {'name1': '横田', 'name2': '東横田', 'dist': 15},
    {'name1': '東横田', 'name2': '馬来田', 'dist': 31},
    {'name1': '馬来田', 'name2': '下郡', 'dist': 13},
    {'name1': '下郡', 'name2': '小櫃', 'dist': 30},
    {'name1': '小櫃', 'name2': '俵田', 'dist': 18},
    {'name1': '俵田', 'name2': '久留里', 'dist': 26},
    {'name1': '久留里', 'name2': '平山', 'dist': 31},
    {'name1': '平山', 'name2': '上総松丘', 'dist': 26},
    {'name1': '上総松丘', 'name2': '上総亀山', 'dist': 39},
    {'name1': '大網', 'name2': '福俵', 'dist': 33},
    {'name1': '福俵', 'name2': '東金', 'dist': 25},
    {'name1': '東金', 'name2': '求名', 'dist': 38},
    {'name1': '求名', 'name2': '成東', 'dist': 42},
    ...
    {'name1': '佐倉', 'name2': '酒々井', 'dist': 64},
    {'name1': '酒々井', 'name2': '成田', 'dist': 67},
    ...
    {'name1': '香取', 'name2': '十二橋', 'dist': 30},
    {'name1': '十二橋', 'name2': '潮来', 'dist': 22},
    {'name1': '潮来', 'name2': '延方', 'dist': 52},
    {'name1': '延方', 'name2': '鹿島神宮', 'dist': 38},
    {'name1': '鹿島神宮', 'name2': '鹿島サッカースタジアム', 'dist': 32},
    {'name1': '成田', 'name2': '下総松崎', 'dist': 51},
    {'name1': '下総松崎', 'name2': '安食', 'dist': 46},
    ...
    {'name1': '藤代', 'name2': '龍ケ崎市', 'dist': 21},
    {'name1': '龍ケ崎市', 'name2': '牛久', 'dist': 51},
    ...
    {'name1': '富田', 'name2': 'あしかがフラワーパーク', 'dist': 9},
    {'name1': 'あしかがフラワーパーク', 'name2': '足利', 'dist': 62},
    ...
    {'name1': '八王子', 'name2': '北八王子', 'dist': 31},
    {'name1': '北八王子', 'name2': '小宮', 'dist': 20},
    {'name1': '小宮', 'name2': '拝島', 'dist': 48},
    {'name1': '拝島', 'name2': '東福生', 'dist': 28},
    {'name1': '東福生', 'name2': '箱根ヶ崎', 'dist': 30},
    {'name1': '箱根ヶ崎', 'name2': '金子', 'dist': 48},
    {'name1': '金子', 'name2': '東飯能', 'dist': 51},
    {'name1': '東飯能', 'name2': '高麗川', 'dist': 55},
    {'name1': '高麗川', 'name2': '毛呂', 'dist': 58},
    {'name1': '毛呂', 'name2': '越生', 'dist': 27},
    {'name1': '越生', 'name2': '明覚', 'dist': 52},
    {'name1': '明覚', 'name2': '小川町', 'dist': 80},
    {'name1': '小川町', 'name2': '竹沢', 'dist': 35},
    {'name1': '竹沢', 'name2': '折原', 'dist': 40},
    {'name1': '折原', 'name2': '寄居', 'dist': 36},
    {'name1': '寄居', 'name2': '用土', 'dist': 45},
    {'name1': '用土', 'name2': '松久', 'dist': 27},
    {'name1': '松久', 'name2': '児玉', 'dist': 48},
    {'name1': '児玉', 'name2': '丹荘', 'dist': 41},
    {'name1': '丹荘', 'name2': '群馬藤岡', 'dist': 47},
    {'name1': '群馬藤岡', 'name2': '北藤岡', 'dist': 37},
    {'name1': '北藤岡', 'name2': '倉賀野', 'dist': 36},
    ...
    {'name1': '宇都宮', 'name2': '鶴田', 'dist': 48},
    {'name1': '鶴田', 'name2': '鹿沼', 'dist': 95},
    {'name1': '鹿沼', 'name2': '文挟', 'dist': 81},
    {'name1': '文挟', 'name2': '下野大沢', 'dist': 58},
    {'name1': '下野大沢', 'name2': '今市', 'dist': 57},
    {'name1': '今市', 'name2': '日光', 'dist': 66},
    {'name1': '宝積寺', 'name2': '下野花岡', 'dist': 39},
    {'name1': '下野花岡', 'name2': '仁井田', 'dist': 20},
    {'name1': '仁井田', 'name2': '鴻野山', 'dist': 24},
    {'name1': '鴻野山', 'name2': '大金', 'dist': 44},
    {'name1': '大金', 'name2': '小塙', 'dist': 26},
    {'name1': '小塙', 'name2': '滝', 'dist': 22},
    {'name1': '滝', 'name2': '烏山', 'dist': 29},
    ...
    {'name1': 'いわき', 'name2': '草野', 'dist': 54},
    {'name1': '草野', 'name2': '四ツ倉', 'dist': 44},
    {'name1': '四ツ倉', 'name2': '久ノ浜', 'dist': 48},
    {'name1': '久ノ浜', 'name2': '末続', 'dist': 36},
    {'name1': '末続', 'name2': '広野', 'dist': 48},
    {'name1': '広野', 'name2': 'Ｊヴィレッジ', 'dist': 35},
    {'name1': 'Ｊヴィレッジ', 'name2': '木戸', 'dist': 19},
    {'name1': '木戸', 'name2': '竜田', 'dist': 31},
    {'name1': '竜田', 'name2': '富岡', 'dist': 69},
    {'name1': '富岡', 'name2': '夜ノ森', 'dist': 52},
    {'name1': '夜ノ森', 'name2': '大野', 'dist': 49},
    {'name1': '大野', 'name2': '双葉', 'dist': 58},
    {'name1': '双葉', 'name2': '浪江', 'dist': 49},
    ...
    {'name1': '水戸', 'name2': '常陸青柳', 'dist': 19},
    {'name1': '常陸青柳', 'name2': '常陸津田', 'dist': 22},
    {'name1': '常陸津田', 'name2': '後台', 'dist': 24},
    {'name1': '後台', 'name2': '下菅谷', 'dist': 13},
    {'name1': '下菅谷', 'name2': '中菅谷', 'dist': 12},
    {'name1': '中菅谷', 'name2': '上菅谷', 'dist': 11},
    {'name1': '上菅谷', 'name2': '常陸鴻巣', 'dist': 33},
    {'name1': '常陸鴻巣', 'name2': '瓜連', 'dist': 33},
    {'name1': '瓜連', 'name2': '静', 'dist': 14},
    {'name1': '静', 'name2': '常陸大宮', 'dist': 53},
    {'name1': '常陸大宮', 'name2': '玉川村', 'dist': 54},
    {'name1': '玉川村', 'name2': '野上原', 'dist': 37},
    {'name1': '野上原', 'name2': '山方宿', 'dist': 27},
    {'name1': '山方宿', 'name2': '中舟生', 'dist': 27},
    {'name1': '中舟生', 'name2': '下小川', 'dist': 28},
    {'name1': '下小川', 'name2': '西金', 'dist': 34},
    {'name1': '西金', 'name2': '上小川', 'dist': 32},
    {'name1': '上小川', 'name2': '袋田', 'dist': 45},
    {'name1': '袋田', 'name2': '常陸大子', 'dist': 38},
    {'name1': '上菅谷', 'name2': '南酒出', 'dist': 25},
    {'name1': '南酒出', 'name2': '額田', 'dist': 11},
    {'name1': '額田', 'name2': '河合', 'dist': 31},
    {'name1': '河合', 'name2': '谷河原', 'dist': 15},
    {'name1': '谷河原', 'name2': '常陸太田', 'dist': 13},
    ...
    {'name1': '小淵沢', 'name2': '甲斐小泉', 'dist': 71},
    {'name1': '甲斐小泉', 'name2': '甲斐大泉', 'dist': 51},
    {'name1': '甲斐大泉', 'name2': '清里', 'dist': 53},
    {'name1': '清里', 'name2': '野辺山', 'dist': 59},
